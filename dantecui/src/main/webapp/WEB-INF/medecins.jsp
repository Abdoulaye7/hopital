...
<div class="container mt-4">
    <h2 class="text-primary">Liste des médecins</h2>
    <a href="<c:url value='/formulaireMedecin'/>" class="btn btn-primary mt-3"><i class="fas fa-plus"></i> Ajouter Médecin</a>
    ...
    <table class="table table-hover mt-3">
      ...
      <tbody>
        <c:forEach var="medecin" items="${listeMedecin}" varStatus="loop">
              <tr class="table-light">
                    ...
                    <td>${medecin.prenom}</td>
                     <td>${medecin.dateNaissance}</td>
                      <td>${medecin.service.id}</td>
                      <td>
                        <a href="<c:url value='/modifierMedecin'/>?id=${medecin.id}" class="btn btn-primary"><i class="fas fa-edit"></i> Modifier</a>

                          <form action="<c:url value='/supprimerMedecin'/>" method="post" style="display: inline;">
